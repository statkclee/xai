...
# 책임있는 인공지능 [^responsible-ai] [@smith2018the] {#responsible-ai}

[^responsible-ai]: [삼성 뉴스룸 (http://bit.ly/33aZQL1), "인공지능에 책임감을 허하라!… 고개 드는 ‘리스폰서블 AI’론(論)"](http://bit.ly/33aZQL1)
...
# XAI 작업흐름 [^xai-dod] {#xai-workflow}

[^xai-dod]: [Dr. Matt Turek, "Explainable Artificial Intelligence (XAI)", DARPA](https://www.darpa.mil/program/explainable-artificial-intelligence)
